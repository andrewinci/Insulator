...
import insulator.lib.CONFIG_FILE_NAME
import insulator.lib.GITHUB_REPO
import insulator.lib.LATEST_RELEASE_API_ENDPOINT
import insulator.lib.VERSION_PROPERTY
    ...
    fun getAppVersion(): Either<Throwable, String> {
        ...
        return if (File(configPath).exists())
            Properties()
                ...
                ?: Exception(VERSION_PROPERTY).left()
